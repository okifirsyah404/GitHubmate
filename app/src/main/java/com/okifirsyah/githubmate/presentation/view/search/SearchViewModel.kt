...
class SearchViewModel(private val useCase: GitHubUserUseCaseImpl) : ViewModel() {
    ...
    val gitHubUserSearchResult: LiveData<ApiResponse<List<GitHubUserResponse>>> by lazy { _gitHubUserSearchResult }
    private val _gitHubUserSearchResult = MutableLiveData<ApiResponse<List<GitHubUserResponse>>>()
